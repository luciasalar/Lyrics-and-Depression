...
class SearchGoogle:
    ...
    def search_google(self, SubtextFile):
        ...
        counter = 0
        f = open(self.path + '/searchQuote2/searchText{}.csv'.format(str(datetime.datetime.now())), 'w')
...
participants = pd.read_csv('/afs/inf.ed.ac.uk/user/s16/s1690903/share/QuoteAndDepression/data/missing_search.csv')

s = SearchGoogle(path=sp.path, textFile=participants)
s.get_all_queries(3160, 59065)
